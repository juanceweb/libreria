...
$recibos2Dpagos_add = NULL; // Initialize page object first

class crecibos2Dpagos_add extends crecibos2Dpagos {
	...
	// Page object name
	var $PageObjName = 'recibos2Dpagos_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "recibos2Dpagosview.php")
	...
	function LoadDefaultValues() {
		$this->tipoFlujo->CurrentValue = NULL;
		$this->tipoFlujo->OldValue = $this->tipoFlujo->CurrentValue;
		...
		$this->importeMovimientos->CurrentValue = NULL;
		$this->importeMovimientos->OldValue = $this->importeMovimientos->CurrentValue;
		$this->importeAdelantos->CurrentValue = NULL;
		$this->importeAdelantos->OldValue = $this->importeAdelantos->CurrentValue;
		$this->nroComprobante->CurrentValue = NULL;
		$this->nroComprobante->OldValue = $this->nroComprobante->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// tipoFlujo
		$this->tipoFlujo->SetDbValueDef($rsnew, $this->tipoFlujo->CurrentValue, NULL, FALSE);
		...
		// importeMovimientos
		$this->importeMovimientos->SetDbValueDef($rsnew, $this->importeMovimientos->CurrentValue, NULL, FALSE);

		// importeAdelantos
		$this->importeAdelantos->SetDbValueDef($rsnew, $this->importeAdelantos->CurrentValue, NULL, FALSE);

		// nroComprobante
		$this->nroComprobante->SetDbValueDef($rsnew, $this->nroComprobante->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($recibos2Dpagos_add)) $recibos2Dpagos_add = new crecibos2Dpagos_add();

// Page init
$recibos2Dpagos_add->Page_Init();

// Page main
$recibos2Dpagos_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$recibos2Dpagos_add->Page_Render();
?>
...
var CurrentForm = frecibos2Dpagosadd = new ew_Form("frecibos2Dpagosadd", "add");

// Validate form
frecibos2Dpagosadd.Validate = function() {
...
frecibos2Dpagosadd.Form_CustomValidate = 
...
frecibos2Dpagosadd.ValidateRequired = true;
<?php } else { ?>
frecibos2Dpagosadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
frecibos2Dpagosadd.Lists["x_tipoFlujo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
frecibos2Dpagosadd.Lists["x_tipoFlujo"].Options = <?php echo json_encode($recibos2Dpagos->tipoFlujo->Options()) ?>;
frecibos2Dpagosadd.Lists["x_idTercero"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"terceros"};
...
<?php if (!$recibos2Dpagos_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $recibos2Dpagos_add->ShowPageHeader(); ?>
<?php
$recibos2Dpagos_add->ShowMessage();
?>
<form name="frecibos2Dpagosadd" id="frecibos2Dpagosadd" class="<?php echo $recibos2Dpagos_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($recibos2Dpagos_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $recibos2Dpagos_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("frecibos2Dpagosadd", "x_fecha", 0);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $recibos2Dpagos_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
frecibos2Dpagosadd.Init();
</script>
<?php
$recibos2Dpagos_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$recibos2Dpagos_add->Page_Terminate();
?>
