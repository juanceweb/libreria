...
class cusuarios_list extends cusuarios {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->modo->AdvancedSearch->ToJSON(), ","); // Field modo
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field modo
		$this->modo->AdvancedSearch->SearchValue = @$filter["x_modo"];
		$this->modo->AdvancedSearch->SearchOperator = @$filter["z_modo"];
		$this->modo->AdvancedSearch->SearchCondition = @$filter["v_modo"];
		$this->modo->AdvancedSearch->SearchValue2 = @$filter["y_modo"];
		$this->modo->AdvancedSearch->SearchOperator2 = @$filter["w_modo"];
		$this->modo->AdvancedSearch->Save();
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->idNivel, $bCtrl); // idNivel
			$this->UpdateSort($this->activo, $bCtrl); // activo
			$this->UpdateSort($this->modo, $bCtrl); // modo
...
fusuarioslist.Lists["x_activo[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioslist.Lists["x_activo[]"].Options = <?php echo json_encode($usuarios->activo->Options()) ?>;
fusuarioslist.Lists["x_modo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioslist.Lists["x_modo"].Options = <?php echo json_encode($usuarios->modo->Options()) ?>;
...
<option value="10"<?php if ($usuarios_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
<option value="20"<?php if ($usuarios_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
<option value="40"<?php if ($usuarios_list->DisplayRecs == 40) { ?> selected<?php } ?>>40</option>
<option value="80"<?php if ($usuarios_list->DisplayRecs == 80) { ?> selected<?php } ?>>80</option>
<option value="160"<?php if ($usuarios_list->DisplayRecs == 160) { ?> selected<?php } ?>>160</option>
</select>
</div>
<?php } ?>
</form>
...
<?php if ($usuarios->contrasenia->Visible) { // contrasenia ?>
	...
	<?php } else { ?>
		<th data-name="contrasenia"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->contrasenia) ?>',2);"><div id="elh_usuarios_contrasenia" class="usuarios_contrasenia">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->contrasenia->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->contrasenia->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->contrasenia->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($usuarios->apellido->Visible) { // apellido ?>
	...
	<?php } else { ?>
		<th data-name="apellido"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->apellido) ?>',2);"><div id="elh_usuarios_apellido" class="usuarios_apellido">
...
<?php if ($usuarios->_email->Visible) { // email ?>
	...
	<?php } else { ?>
		<th data-name="_email"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->_email) ?>',2);"><div id="elh_usuarios__email" class="usuarios__email">
...
<?php if ($usuarios->idNivel->Visible) { // idNivel ?>
	...
	<?php } else { ?>
		<th data-name="idNivel"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->idNivel) ?>',2);"><div id="elh_usuarios_idNivel" class="usuarios_idNivel">
...
<?php if ($usuarios->activo->Visible) { // activo ?>
	...
	<?php } else { ?>
		<th data-name="activo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->activo) ?>',2);"><div id="elh_usuarios_activo" class="usuarios_activo">
...
<?php if ($usuarios->modo->Visible) { // modo ?>
	<?php if ($usuarios->SortUrl($usuarios->modo) == "") { ?>
		<th data-name="modo"><div id="elh_usuarios_modo" class="usuarios_modo"><div class="ewTableHeaderCaption"><?php echo $usuarios->modo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="modo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->modo) ?>',2);"><div id="elh_usuarios_modo" class="usuarios_modo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->modo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->modo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->modo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_apellido" class="usuarios_apellido">
...
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios__email" class="usuarios__email">
...
<?php echo $usuarios->activo->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuarios->modo->Visible) { // modo ?>
		<td data-name="modo"<?php echo $usuarios->modo->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_modo" class="usuarios_modo">
