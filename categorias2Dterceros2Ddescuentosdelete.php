...
$categorias2Dterceros2Ddescuentos_delete = NULL; // Initialize page object first

class ccategorias2Dterceros2Ddescuentos_delete extends ccategorias2Dterceros2Ddescuentos {
	...
	// Page object name
	var $PageObjName = 'categorias2Dterceros2Ddescuentos_delete';
	...
	function Page_Init() {
		...
		if (!$Security->CanDelete()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("categorias2Dterceros2Ddescuentoslist.php"));
			else
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("categorias2Dterceros2Ddescuentoslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in categorias2Dterceros2Ddescuentos class, categorias2Dterceros2Ddescuentosinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("categorias2Dterceros2Ddescuentoslist.php"); // Return to list
			}
		}
	}
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("categorias2Dterceros2Ddescuentoslist.php"), "", $this->TableVar, TRUE);
		$PageId = "delete";
...
// Create page object
if (!isset($categorias2Dterceros2Ddescuentos_delete)) $categorias2Dterceros2Ddescuentos_delete = new ccategorias2Dterceros2Ddescuentos_delete();

// Page init
$categorias2Dterceros2Ddescuentos_delete->Page_Init();

// Page main
$categorias2Dterceros2Ddescuentos_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$categorias2Dterceros2Ddescuentos_delete->Page_Render();
?>
...
var CurrentForm = fcategorias2Dterceros2Ddescuentosdelete = new ew_Form("fcategorias2Dterceros2Ddescuentosdelete", "delete");

// Form_CustomValidate event
fcategorias2Dterceros2Ddescuentosdelete.Form_CustomValidate = 
...
fcategorias2Dterceros2Ddescuentosdelete.ValidateRequired = true;
<?php } else { ?>
fcategorias2Dterceros2Ddescuentosdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcategorias2Dterceros2Ddescuentosdelete.Lists["x_idCategoria"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"categorias2Darticulos"};
fcategorias2Dterceros2Ddescuentosdelete.Lists["x_idTercero"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"terceros"};
...
<?php $categorias2Dterceros2Ddescuentos_delete->ShowPageHeader(); ?>
<?php
$categorias2Dterceros2Ddescuentos_delete->ShowMessage();
?>
<form name="fcategorias2Dterceros2Ddescuentosdelete" id="fcategorias2Dterceros2Ddescuentosdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($categorias2Dterceros2Ddescuentos_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $categorias2Dterceros2Ddescuentos_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="categorias2Dterceros2Ddescuentos">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($categorias2Dterceros2Ddescuentos_delete->RecKeys as $key) { ?>
...
<?php if ($categorias2Dterceros2Ddescuentos->idCategoria->Visible) { // idCategoria ?>
		<th><span id="elh_categorias2Dterceros2Ddescuentos_idCategoria" class="categorias2Dterceros2Ddescuentos_idCategoria"><?php echo $categorias2Dterceros2Ddescuentos->idCategoria->FldCaption() ?></span></th>
<?php } ?>
<?php if ($categorias2Dterceros2Ddescuentos->idTercero->Visible) { // idTercero ?>
		<th><span id="elh_categorias2Dterceros2Ddescuentos_idTercero" class="categorias2Dterceros2Ddescuentos_idTercero"><?php echo $categorias2Dterceros2Ddescuentos->idTercero->FldCaption() ?></span></th>
<?php } ?>
<?php if ($categorias2Dterceros2Ddescuentos->descuento->Visible) { // descuento ?>
		<th><span id="elh_categorias2Dterceros2Ddescuentos_descuento" class="categorias2Dterceros2Ddescuentos_descuento"><?php echo $categorias2Dterceros2Ddescuentos->descuento->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$categorias2Dterceros2Ddescuentos_delete->RecCnt = 0;
$i = 0;
while (!$categorias2Dterceros2Ddescuentos_delete->Recordset->EOF) {
	$categorias2Dterceros2Ddescuentos_delete->RecCnt++;
	$categorias2Dterceros2Ddescuentos_delete->RowCnt++;

	// Set row properties
	$categorias2Dterceros2Ddescuentos->ResetAttrs();
	$categorias2Dterceros2Ddescuentos->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$categorias2Dterceros2Ddescuentos_delete->LoadRowValues($categorias2Dterceros2Ddescuentos_delete->Recordset);

	// Render row
	$categorias2Dterceros2Ddescuentos_delete->RenderRow();
?>
	<tr<?php echo $categorias2Dterceros2Ddescuentos->RowAttributes() ?>>
<?php if ($categorias2Dterceros2Ddescuentos->idCategoria->Visible) { // idCategoria ?>
		<td<?php echo $categorias2Dterceros2Ddescuentos->idCategoria->CellAttributes() ?>>
<span id="el<?php echo $categorias2Dterceros2Ddescuentos_delete->RowCnt ?>_categorias2Dterceros2Ddescuentos_idCategoria" class="categorias2Dterceros2Ddescuentos_idCategoria">
...
<?php } ?>
<?php if ($categorias2Dterceros2Ddescuentos->idTercero->Visible) { // idTercero ?>
		<td<?php echo $categorias2Dterceros2Ddescuentos->idTercero->CellAttributes() ?>>
<span id="el<?php echo $categorias2Dterceros2Ddescuentos_delete->RowCnt ?>_categorias2Dterceros2Ddescuentos_idTercero" class="categorias2Dterceros2Ddescuentos_idTercero">
...
<?php } ?>
<?php if ($categorias2Dterceros2Ddescuentos->descuento->Visible) { // descuento ?>
		<td<?php echo $categorias2Dterceros2Ddescuentos->descuento->CellAttributes() ?>>
<span id="el<?php echo $categorias2Dterceros2Ddescuentos_delete->RowCnt ?>_categorias2Dterceros2Ddescuentos_descuento" class="categorias2Dterceros2Ddescuentos_descuento">
...
<?php
	$categorias2Dterceros2Ddescuentos_delete->Recordset->MoveNext();
}
$categorias2Dterceros2Ddescuentos_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $categorias2Dterceros2Ddescuentos_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fcategorias2Dterceros2Ddescuentosdelete.Init();
</script>
<?php
$categorias2Dterceros2Ddescuentos_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$categorias2Dterceros2Ddescuentos_delete->Page_Terminate();
?>
