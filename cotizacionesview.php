...
$cotizaciones_view = NULL; // Initialize page object first

class ccotizaciones_view extends ccotizaciones {
	...
	// Page object name
	var $PageObjName = 'cotizaciones_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "cotizacioneslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cotizacioneslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cotizacioneslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($cotizaciones_view)) $cotizaciones_view = new ccotizaciones_view();

// Page init
$cotizaciones_view->Page_Init();

// Page main
$cotizaciones_view->Page_Main();
...
var CurrentForm = fcotizacionesview = new ew_Form("fcotizacionesview", "view");

// Form_CustomValidate event
fcotizacionesview.Form_CustomValidate = 
...
fcotizacionesview.ValidateRequired = true;
<?php } else { ?>
fcotizacionesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcotizacionesview.Lists["x_idTercero"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"terceros"};
fcotizacionesview.Lists["x_contable[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcotizacionesview.Lists["x_contable[]"].Options = <?php echo json_encode($cotizaciones->contable->Options()) ?>;
...
<?php if ($cotizaciones->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$cotizaciones_view->IsModal) { ?>
<?php if ($cotizaciones->Export == "") { ?>
...
<?php
	foreach ($cotizaciones_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$cotizaciones_view->IsModal) { ?>
<?php if ($cotizaciones->Export == "") { ?>
...
?>
<form name="fcotizacionesview" id="fcotizacionesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cotizaciones_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cotizaciones_view->Token ?>">
<?php } ?>
...
<?php if ($cotizaciones->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_cotizaciones_id"><?php echo $cotizaciones->id->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones->idTercero->Visible) { // idTercero ?>
	<tr id="r_idTercero">
		<td><span id="elh_cotizaciones_idTercero"><?php echo $cotizaciones->idTercero->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->idTercero->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_cotizaciones_fecha"><?php echo $cotizaciones->fecha->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones->contable->Visible) { // contable ?>
	<tr id="r_contable">
		<td><span id="elh_cotizaciones_contable"><?php echo $cotizaciones->contable->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->contable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones->importeNeto->Visible) { // importeNeto ?>
	<tr id="r_importeNeto">
		<td><span id="elh_cotizaciones_importeNeto"><?php echo $cotizaciones->importeNeto->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->importeNeto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones->importeIva->Visible) { // importeIva ?>
	<tr id="r_importeIva">
		<td><span id="elh_cotizaciones_importeIva"><?php echo $cotizaciones->importeIva->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->importeIva->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones->importeTotal->Visible) { // importeTotal ?>
	<tr id="r_importeTotal">
		<td><span id="elh_cotizaciones_importeTotal"><?php echo $cotizaciones->importeTotal->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->importeTotal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones->vigencia->Visible) { // vigencia ?>
	<tr id="r_vigencia">
		<td><span id="elh_cotizaciones_vigencia"><?php echo $cotizaciones->vigencia->FldCaption() ?></span></td>
...
<?php echo $cotizaciones->vigencia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$cotizaciones_view->Page_Terminate();
?>
