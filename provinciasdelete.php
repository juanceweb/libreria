...
fprovinciasdelete.Lists["x_idPais"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"paises"};
...
<?php if ($provincias->denominacion->Visible) { // denominacion ?>
		<th><span id="elh_provincias_denominacion" class="provincias_denominacion"><?php echo $provincias->denominacion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($provincias->idPais->Visible) { // idPais ?>
		<th><span id="elh_provincias_idPais" class="provincias_idPais"><?php echo $provincias->idPais->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($provincias->denominacion->Visible) { // denominacion ?>
		<td<?php echo $provincias->denominacion->CellAttributes() ?>>
<span id="el<?php echo $provincias_delete->RowCnt ?>_provincias_denominacion" class="provincias_denominacion">
...
<?php } ?>
<?php if ($provincias->idPais->Visible) { // idPais ?>
		<td<?php echo $provincias->idPais->CellAttributes() ?>>
<span id="el<?php echo $provincias_delete->RowCnt ?>_provincias_idPais" class="provincias_idPais">
