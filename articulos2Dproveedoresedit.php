...
$articulos2Dproveedores_edit = NULL; // Initialize page object first

class carticulos2Dproveedores_edit extends carticulos2Dproveedores {
	...
	// Page object name
	var $PageObjName = 'articulos2Dproveedores_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("articulos2Dproveedoreslist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($articulos2Dproveedores_edit)) $articulos2Dproveedores_edit = new carticulos2Dproveedores_edit();

// Page init
$articulos2Dproveedores_edit->Page_Init();

// Page main
$articulos2Dproveedores_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$articulos2Dproveedores_edit->Page_Render();
?>
...
var CurrentForm = farticulos2Dproveedoresedit = new ew_Form("farticulos2Dproveedoresedit", "edit");

// Validate form
farticulos2Dproveedoresedit.Validate = function() {
...
farticulos2Dproveedoresedit.Form_CustomValidate = 
...
farticulos2Dproveedoresedit.ValidateRequired = true;
<?php } else { ?>
farticulos2Dproveedoresedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
farticulos2Dproveedoresedit.Lists["x_idArticulo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacionExterna","x_denominacionInterna","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"articulos"};
farticulos2Dproveedoresedit.Lists["x_idAlicuotaIva"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_valor","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"alicuotas2Diva"};
farticulos2Dproveedoresedit.Lists["x_idMoneda"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_simbolo","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"monedas"};
farticulos2Dproveedoresedit.Lists["x_idTercero"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","x_dto1","x_dto2","x_dto3"],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"terceros"};
...
<?php if (!$articulos2Dproveedores_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $articulos2Dproveedores_edit->ShowPageHeader(); ?>
<?php
$articulos2Dproveedores_edit->ShowMessage();
?>
<form name="farticulos2Dproveedoresedit" id="farticulos2Dproveedoresedit" class="<?php echo $articulos2Dproveedores_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($articulos2Dproveedores_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $articulos2Dproveedores_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="articulos2Dproveedores" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($articulos2Dproveedores->id->CurrentValue) ?>">
<?php if (!$articulos2Dproveedores_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $articulos2Dproveedores_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
farticulos2Dproveedoresedit.Init();
</script>
<?php
$articulos2Dproveedores_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
$(document).ready(function() {
	...
	$.ajax({
		...
		success: function(data) {
			var unidadMedida = data.exito.idUnidadMedida;
				...
				success: function(response) {
					if (response.exito) {
						...
						response.exito.forEach(unidad => {
							if(unidad.id == unidadMedida){
								html += '<option value="' + unidad.id + '" selected>' + unidad.denominacion + '</option>';
							}else{
...
<?php
$articulos2Dproveedores_edit->Page_Terminate();
?>
