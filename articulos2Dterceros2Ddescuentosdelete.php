...
$articulos2Dterceros2Ddescuentos_delete = NULL; // Initialize page object first

class carticulos2Dterceros2Ddescuentos_delete extends carticulos2Dterceros2Ddescuentos {
	...
	// Page object name
	var $PageObjName = 'articulos2Dterceros2Ddescuentos_delete';
	...
	function Page_Init() {
		...
		if (!$Security->CanDelete()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("articulos2Dterceros2Ddescuentoslist.php"));
			else
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("articulos2Dterceros2Ddescuentoslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in articulos2Dterceros2Ddescuentos class, articulos2Dterceros2Ddescuentosinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("articulos2Dterceros2Ddescuentoslist.php"); // Return to list
			}
		}
	}
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("articulos2Dterceros2Ddescuentoslist.php"), "", $this->TableVar, TRUE);
		$PageId = "delete";
...
// Create page object
if (!isset($articulos2Dterceros2Ddescuentos_delete)) $articulos2Dterceros2Ddescuentos_delete = new carticulos2Dterceros2Ddescuentos_delete();

// Page init
$articulos2Dterceros2Ddescuentos_delete->Page_Init();

// Page main
$articulos2Dterceros2Ddescuentos_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$articulos2Dterceros2Ddescuentos_delete->Page_Render();
?>
...
var CurrentForm = farticulos2Dterceros2Ddescuentosdelete = new ew_Form("farticulos2Dterceros2Ddescuentosdelete", "delete");

// Form_CustomValidate event
farticulos2Dterceros2Ddescuentosdelete.Form_CustomValidate = 
...
farticulos2Dterceros2Ddescuentosdelete.ValidateRequired = true;
<?php } else { ?>
farticulos2Dterceros2Ddescuentosdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
farticulos2Dterceros2Ddescuentosdelete.Lists["x_idArticulo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacionExterna","x_denominacionInterna","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"articulos"};
farticulos2Dterceros2Ddescuentosdelete.Lists["x_idTercero"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"terceros"};
...
<?php $articulos2Dterceros2Ddescuentos_delete->ShowPageHeader(); ?>
<?php
$articulos2Dterceros2Ddescuentos_delete->ShowMessage();
?>
<form name="farticulos2Dterceros2Ddescuentosdelete" id="farticulos2Dterceros2Ddescuentosdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($articulos2Dterceros2Ddescuentos_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $articulos2Dterceros2Ddescuentos_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="articulos2Dterceros2Ddescuentos">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($articulos2Dterceros2Ddescuentos_delete->RecKeys as $key) { ?>
...
<?php if ($articulos2Dterceros2Ddescuentos->idArticulo->Visible) { // idArticulo ?>
		<th><span id="elh_articulos2Dterceros2Ddescuentos_idArticulo" class="articulos2Dterceros2Ddescuentos_idArticulo"><?php echo $articulos2Dterceros2Ddescuentos->idArticulo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($articulos2Dterceros2Ddescuentos->idTercero->Visible) { // idTercero ?>
		<th><span id="elh_articulos2Dterceros2Ddescuentos_idTercero" class="articulos2Dterceros2Ddescuentos_idTercero"><?php echo $articulos2Dterceros2Ddescuentos->idTercero->FldCaption() ?></span></th>
<?php } ?>
<?php if ($articulos2Dterceros2Ddescuentos->descuento->Visible) { // descuento ?>
		<th><span id="elh_articulos2Dterceros2Ddescuentos_descuento" class="articulos2Dterceros2Ddescuentos_descuento"><?php echo $articulos2Dterceros2Ddescuentos->descuento->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$articulos2Dterceros2Ddescuentos_delete->RecCnt = 0;
$i = 0;
while (!$articulos2Dterceros2Ddescuentos_delete->Recordset->EOF) {
	$articulos2Dterceros2Ddescuentos_delete->RecCnt++;
	$articulos2Dterceros2Ddescuentos_delete->RowCnt++;

	// Set row properties
	$articulos2Dterceros2Ddescuentos->ResetAttrs();
	$articulos2Dterceros2Ddescuentos->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$articulos2Dterceros2Ddescuentos_delete->LoadRowValues($articulos2Dterceros2Ddescuentos_delete->Recordset);

	// Render row
	$articulos2Dterceros2Ddescuentos_delete->RenderRow();
?>
	<tr<?php echo $articulos2Dterceros2Ddescuentos->RowAttributes() ?>>
<?php if ($articulos2Dterceros2Ddescuentos->idArticulo->Visible) { // idArticulo ?>
		<td<?php echo $articulos2Dterceros2Ddescuentos->idArticulo->CellAttributes() ?>>
<span id="el<?php echo $articulos2Dterceros2Ddescuentos_delete->RowCnt ?>_articulos2Dterceros2Ddescuentos_idArticulo" class="articulos2Dterceros2Ddescuentos_idArticulo">
...
<?php } ?>
<?php if ($articulos2Dterceros2Ddescuentos->idTercero->Visible) { // idTercero ?>
		<td<?php echo $articulos2Dterceros2Ddescuentos->idTercero->CellAttributes() ?>>
<span id="el<?php echo $articulos2Dterceros2Ddescuentos_delete->RowCnt ?>_articulos2Dterceros2Ddescuentos_idTercero" class="articulos2Dterceros2Ddescuentos_idTercero">
...
<?php } ?>
<?php if ($articulos2Dterceros2Ddescuentos->descuento->Visible) { // descuento ?>
		<td<?php echo $articulos2Dterceros2Ddescuentos->descuento->CellAttributes() ?>>
<span id="el<?php echo $articulos2Dterceros2Ddescuentos_delete->RowCnt ?>_articulos2Dterceros2Ddescuentos_descuento" class="articulos2Dterceros2Ddescuentos_descuento">
...
<?php
	$articulos2Dterceros2Ddescuentos_delete->Recordset->MoveNext();
}
$articulos2Dterceros2Ddescuentos_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $articulos2Dterceros2Ddescuentos_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
farticulos2Dterceros2Ddescuentosdelete.Init();
</script>
<?php
$articulos2Dterceros2Ddescuentos_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$articulos2Dterceros2Ddescuentos_delete->Page_Terminate();
?>
