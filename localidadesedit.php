	...
	function RenderRow() {
		...
		$this->idPartido->ViewCustomAttributes = "";
			...
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				...
				$this->idProvincia->ViewValue = $Language->Phrase("PleaseSelect");
			}
			...
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				...
				$this->idPartido->ViewValue = $Language->Phrase("PleaseSelect");
			}
			$arwrk = ($rswrk) ? $rswrk->GetRows() : array();
			if ($rswrk) $rswrk->Close();
...
flocalidadesedit.Lists["x_idProvincia"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":["x_idPartido"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincias"};
flocalidadesedit.Lists["x_idPartido"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":["x_idProvincia"],"ChildFields":[],"FilterFields":["x_idProvincia"],"Options":[],"Template":"","LinkTable":"partidos"};
...
<?php if ($localidades->denominacion->Visible) { // denominacion ?>
	<div id="r_denominacion" class="form-group">
		<label id="elh_localidades_denominacion" for="x_denominacion" class="col-sm-2 control-label ewLabel"><?php echo $localidades->denominacion->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $localidades->denominacion->CellAttributes() ?>>
<span id="el_localidades_denominacion">
<input type="text" data-table="localidades" data-field="x_denominacion" name="x_denominacion" id="x_denominacion" size="30" maxlength="31" placeholder="<?php echo ew_HtmlEncode($localidades->denominacion->getPlaceHolder()) ?>" value="<?php echo $localidades->denominacion->EditValue ?>"<?php echo $localidades->denominacion->EditAttributes() ?>>
</span>
<?php echo $localidades->denominacion->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($localidades->idProvincia->Visible) { // idProvincia ?>
	<div id="r_idProvincia" class="form-group">
		<label id="elh_localidades_idProvincia" for="x_idProvincia" class="col-sm-2 control-label ewLabel"><?php echo $localidades->idProvincia->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $localidades->idProvincia->CellAttributes() ?>>
<span id="el_localidades_idProvincia">
<?php $localidades->idProvincia->EditAttrs["onchange"] = "ew_UpdateOpt.call(this); " . @$localidades->idProvincia->EditAttrs["onchange"]; ?>
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_idProvincia"><?php echo (strval($localidades->idProvincia->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $localidades->idProvincia->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($localidades->idProvincia->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_idProvincia',m:0,n:10});" class="ewLookupBtn btn btn-default btn-sm"><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="localidades" data-field="x_idProvincia" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $localidades->idProvincia->DisplayValueSeparatorAttribute() ?>" name="x_idProvincia" id="x_idProvincia" value="<?php echo $localidades->idProvincia->CurrentValue ?>"<?php echo $localidades->idProvincia->EditAttributes() ?>>
<input type="hidden" name="s_x_idProvincia" id="s_x_idProvincia" value="<?php echo $localidades->idProvincia->LookupFilterQuery() ?>">
</span>
<?php echo $localidades->idProvincia->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($localidades->idPartido->Visible) { // idPartido ?>
	<div id="r_idPartido" class="form-group">
		<label id="elh_localidades_idPartido" for="x_idPartido" class="col-sm-2 control-label ewLabel"><?php echo $localidades->idPartido->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $localidades->idPartido->CellAttributes() ?>>
<span id="el_localidades_idPartido">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_idPartido"><?php echo (strval($localidades->idPartido->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $localidades->idPartido->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($localidades->idPartido->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_idPartido',m:0,n:10});" class="ewLookupBtn btn btn-default btn-sm"><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="localidades" data-field="x_idPartido" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $localidades->idPartido->DisplayValueSeparatorAttribute() ?>" name="x_idPartido" id="x_idPartido" value="<?php echo $localidades->idPartido->CurrentValue ?>"<?php echo $localidades->idPartido->EditAttributes() ?>>
<input type="hidden" name="s_x_idPartido" id="s_x_idPartido" value="<?php echo $localidades->idPartido->LookupFilterQuery() ?>">
</span>
<?php echo $localidades->idPartido->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<input type="hidden" data-table="localidades" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($localidades->id->CurrentValue) ?>">
<?php if (!$localidades_edit->IsModal) { ?>
