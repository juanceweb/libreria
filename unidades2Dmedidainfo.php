...
$unidades2Dmedida = NULL;

//
// Table class for unidades-medida
//
class cunidades2Dmedida extends cTable {
	var $id;
	var $denominacion;
	...
	function __construct() {
		...
		$this->TableVar = 'unidades2Dmedida';
		$this->TableName = 'unidades-medida';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`unidades-medida`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('unidades2Dmedida', 'unidades-medida', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('unidades2Dmedida', 'unidades-medida', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// denominacionCorta
		$this->denominacionCorta = new cField('unidades2Dmedida', 'unidades-medida', 'x_denominacionCorta', 'denominacionCorta', '`denominacionCorta`', '`denominacionCorta`', 200, -1, FALSE, '`denominacionCorta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacionCorta->Sortable = TRUE; // Allow sort
		$this->fields['denominacionCorta'] = &$this->denominacionCorta;

		// indiceConversion
		$this->indiceConversion = new cField('unidades2Dmedida', 'unidades-medida', 'x_indiceConversion', 'indiceConversion', '`indiceConversion`', '`indiceConversion`', 4, -1, FALSE, '`indiceConversion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`unidades-medida`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`denominacion` ASC";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "unidades2Dmedidalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("unidades2Dmedidaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("unidades2Dmedidaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "unidades2Dmedidaadd.php?" . $this->UrlParm($parm);
		else
			$url = "unidades2Dmedidaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("unidades2Dmedidaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("unidades2Dmedidaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("unidades2Dmedidadelete.php", $this->UrlParm());
	}
