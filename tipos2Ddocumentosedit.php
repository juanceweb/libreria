...
$tipos2Ddocumentos_edit = NULL; // Initialize page object first

class ctipos2Ddocumentos_edit extends ctipos2Ddocumentos {
	...
	// Page object name
	var $PageObjName = 'tipos2Ddocumentos_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("tipos2Ddocumentoslist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($tipos2Ddocumentos_edit)) $tipos2Ddocumentos_edit = new ctipos2Ddocumentos_edit();

// Page init
$tipos2Ddocumentos_edit->Page_Init();

// Page main
$tipos2Ddocumentos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tipos2Ddocumentos_edit->Page_Render();
?>
...
var CurrentForm = ftipos2Ddocumentosedit = new ew_Form("ftipos2Ddocumentosedit", "edit");

// Validate form
ftipos2Ddocumentosedit.Validate = function() {
...
ftipos2Ddocumentosedit.Form_CustomValidate = 
...
ftipos2Ddocumentosedit.ValidateRequired = true;
<?php } else { ?>
ftipos2Ddocumentosedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftipos2Ddocumentosedit.Lists["x_activo[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftipos2Ddocumentosedit.Lists["x_activo[]"].Options = <?php echo json_encode($tipos2Ddocumentos->activo->Options()) ?>;
...
<?php if (!$tipos2Ddocumentos_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $tipos2Ddocumentos_edit->ShowPageHeader(); ?>
<?php
$tipos2Ddocumentos_edit->ShowMessage();
?>
<form name="ftipos2Ddocumentosedit" id="ftipos2Ddocumentosedit" class="<?php echo $tipos2Ddocumentos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tipos2Ddocumentos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tipos2Ddocumentos_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="tipos2Ddocumentos" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($tipos2Ddocumentos->id->CurrentValue) ?>">
<?php if (!$tipos2Ddocumentos_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tipos2Ddocumentos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftipos2Ddocumentosedit.Init();
</script>
<?php
$tipos2Ddocumentos_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tipos2Ddocumentos_edit->Page_Terminate();
?>
