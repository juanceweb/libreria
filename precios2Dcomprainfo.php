...
$precios2Dcompra = NULL;

//
// Table class for precios-compra
//
class cprecios2Dcompra extends cTable {
	var $id;
	var $idArticulo;
	var $codExterno;
	var $precioPesos;
	...
	function __construct() {
		...
		$this->TableVar = 'precios2Dcompra';
		$this->TableName = 'precios-compra';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`precios-compra`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('precios2Dcompra', 'precios-compra', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// idArticulo
		$this->idArticulo = new cField('precios2Dcompra', 'precios-compra', 'x_idArticulo', 'idArticulo', '`idArticulo`', '`idArticulo`', 3, -1, FALSE, '`idArticulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// codExterno
		$this->codExterno = new cField('precios2Dcompra', 'precios-compra', 'x_codExterno', 'codExterno', '`codExterno`', '`codExterno`', 200, -1, FALSE, '`codExterno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->codExterno->Sortable = TRUE; // Allow sort
		$this->codExterno->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codExterno'] = &$this->codExterno;

		// precioPesos
		$this->precioPesos = new cField('precios2Dcompra', 'precios-compra', 'x_precioPesos', 'precioPesos', '`precioPesos`', '`precioPesos`', 4, -1, FALSE, '`precioPesos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ultimaActualizacion
		$this->ultimaActualizacion = new cField('precios2Dcompra', 'precios-compra', 'x_ultimaActualizacion', 'ultimaActualizacion', '`ultimaActualizacion`', 'DATE_FORMAT(`ultimaActualizacion`, \'%Y/%m/%d\')', 133, 0, FALSE, '`ultimaActualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// denominacion
		$this->denominacion = new cField('precios2Dcompra', 'precios-compra', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`precios-compra`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "precios2Dcompralist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("precios2Dcompraview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("precios2Dcompraview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "precios2Dcompraadd.php?" . $this->UrlParm($parm);
		else
			$url = "precios2Dcompraadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("precios2Dcompraedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("precios2Dcompraadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("precios2Dcompradelete.php", $this->UrlParm());
	}
