...
$categorias2Dterceros2Ddescuentos_grid = NULL; // Initialize page object first

class ccategorias2Dterceros2Ddescuentos_grid extends ccategorias2Dterceros2Ddescuentos {
	...
	// Page object name
	var $PageObjName = 'categorias2Dterceros2Ddescuentos_grid';

	// Grid form hidden field names
	var $FormName = 'fcategorias2Dterceros2Ddescuentosgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["categorias2Dterceros2Ddescuentos"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "categorias2Darticulos") {
			...
			if ($GLOBALS["categorias2Darticulos"]->EventCancelled) $this->EventCancelled = TRUE;
		}
