...
$tipos2Ddocumentos = NULL;

//
// Table class for tipos-documentos
//
class ctipos2Ddocumentos extends cTable {
	var $id;
	var $denominacion;
	var $activo;
	...
	function __construct() {
		...
		$this->TableVar = 'tipos2Ddocumentos';
		$this->TableName = 'tipos-documentos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tipos-documentos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('tipos2Ddocumentos', 'tipos-documentos', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('tipos2Ddocumentos', 'tipos-documentos', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// activo
		$this->activo = new cField('tipos2Ddocumentos', 'tipos-documentos', 'x_activo', 'activo', '`activo`', '`activo`', 3, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tipos-documentos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tipos2Ddocumentoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tipos2Ddocumentosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tipos2Ddocumentosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tipos2Ddocumentosadd.php?" . $this->UrlParm($parm);
		else
			$url = "tipos2Ddocumentosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("tipos2Ddocumentosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("tipos2Ddocumentosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tipos2Ddocumentosdelete.php", $this->UrlParm());
	}
