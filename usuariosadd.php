...
class cusuarios_add extends cusuarios {
	...
	function AddRow($rsold = NULL) {
		...
		// modo
		$this->modo->SetDbValueDef($rsnew, $this->modo->CurrentValue, NULL, FALSE);
...
fusuariosadd.Lists["x_activo[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuariosadd.Lists["x_activo[]"].Options = <?php echo json_encode($usuarios->activo->Options()) ?>;
fusuariosadd.Lists["x_modo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuariosadd.Lists["x_modo"].Options = <?php echo json_encode($usuarios->modo->Options()) ?>;
