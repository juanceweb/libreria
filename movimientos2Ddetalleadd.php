...
$movimientos2Ddetalle_add = NULL; // Initialize page object first

class cmovimientos2Ddetalle_add extends cmovimientos2Ddetalle {
	...
	// Page object name
	var $PageObjName = 'movimientos2Ddetalle_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "movimientos2Ddetalleview.php")
	...
	function LoadDefaultValues() {
		$this->idMovimientos->CurrentValue = NULL;
		$this->idMovimientos->OldValue = $this->idMovimientos->CurrentValue;
		$this->cant->CurrentValue = NULL;
		$this->cant->OldValue = $this->cant->CurrentValue;
		$this->idUnidadMedida->CurrentValue = NULL;
		$this->idUnidadMedida->OldValue = $this->idUnidadMedida->CurrentValue;
		$this->codProducto->CurrentValue = NULL;
		$this->codProducto->OldValue = $this->codProducto->CurrentValue;
		$this->medida->CurrentValue = NULL;
		$this->medida->OldValue = $this->medida->CurrentValue;
		$this->nombreProducto->CurrentValue = NULL;
		$this->nombreProducto->OldValue = $this->nombreProducto->CurrentValue;
		$this->importeUnitario->CurrentValue = NULL;
		$this->importeUnitario->OldValue = $this->importeUnitario->CurrentValue;
		$this->bonificacion->CurrentValue = NULL;
		$this->bonificacion->OldValue = $this->bonificacion->CurrentValue;
		$this->importeTotal->CurrentValue = NULL;
		$this->importeTotal->OldValue = $this->importeTotal->CurrentValue;
		$this->alicuotaIva->CurrentValue = NULL;
		$this->alicuotaIva->OldValue = $this->alicuotaIva->CurrentValue;
		...
		$this->importePesos->CurrentValue = NULL;
		$this->importePesos->OldValue = $this->importePesos->CurrentValue;
		$this->estadoImportacion->CurrentValue = NULL;
		$this->estadoImportacion->OldValue = $this->estadoImportacion->CurrentValue;
		$this->origenImportacion->CurrentValue = NULL;
		$this->origenImportacion->OldValue = $this->origenImportacion->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// idMovimientos
		$this->idMovimientos->SetDbValueDef($rsnew, $this->idMovimientos->CurrentValue, NULL, FALSE);

		// cant
		$this->cant->SetDbValueDef($rsnew, $this->cant->CurrentValue, NULL, FALSE);

		// idUnidadMedida
		$this->idUnidadMedida->SetDbValueDef($rsnew, $this->idUnidadMedida->CurrentValue, NULL, FALSE);

		// codProducto
		$this->codProducto->SetDbValueDef($rsnew, $this->codProducto->CurrentValue, NULL, FALSE);

		// medida
		$this->medida->SetDbValueDef($rsnew, $this->medida->CurrentValue, NULL, FALSE);

		// nombreProducto
		$this->nombreProducto->SetDbValueDef($rsnew, $this->nombreProducto->CurrentValue, NULL, FALSE);

		// importeUnitario
		$this->importeUnitario->SetDbValueDef($rsnew, $this->importeUnitario->CurrentValue, NULL, FALSE);

		// bonificacion
		$this->bonificacion->SetDbValueDef($rsnew, $this->bonificacion->CurrentValue, NULL, FALSE);

		// importeTotal
		$this->importeTotal->SetDbValueDef($rsnew, $this->importeTotal->CurrentValue, NULL, FALSE);

		// alicuotaIva
		$this->alicuotaIva->SetDbValueDef($rsnew, $this->alicuotaIva->CurrentValue, NULL, FALSE);
		...
		// importePesos
		$this->importePesos->SetDbValueDef($rsnew, $this->importePesos->CurrentValue, NULL, FALSE);

		// estadoImportacion
		$this->estadoImportacion->SetDbValueDef($rsnew, $this->estadoImportacion->CurrentValue, NULL, FALSE);

		// origenImportacion
		$this->origenImportacion->SetDbValueDef($rsnew, $this->origenImportacion->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($movimientos2Ddetalle_add)) $movimientos2Ddetalle_add = new cmovimientos2Ddetalle_add();

// Page init
$movimientos2Ddetalle_add->Page_Init();

// Page main
$movimientos2Ddetalle_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$movimientos2Ddetalle_add->Page_Render();
?>
...
var CurrentForm = fmovimientos2Ddetalleadd = new ew_Form("fmovimientos2Ddetalleadd", "add");

// Validate form
fmovimientos2Ddetalleadd.Validate = function() {
...
fmovimientos2Ddetalleadd.Form_CustomValidate = 
...
fmovimientos2Ddetalleadd.ValidateRequired = true;
<?php } else { ?>
fmovimientos2Ddetalleadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$movimientos2Ddetalle_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $movimientos2Ddetalle_add->ShowPageHeader(); ?>
<?php
$movimientos2Ddetalle_add->ShowMessage();
?>
<form name="fmovimientos2Ddetalleadd" id="fmovimientos2Ddetalleadd" class="<?php echo $movimientos2Ddetalle_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($movimientos2Ddetalle_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $movimientos2Ddetalle_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $movimientos2Ddetalle_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmovimientos2Ddetalleadd.Init();
</script>
<?php
$movimientos2Ddetalle_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$movimientos2Ddetalle_add->Page_Terminate();
?>
