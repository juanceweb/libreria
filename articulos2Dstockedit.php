...
$articulos2Dstock_edit = NULL; // Initialize page object first

class carticulos2Dstock_edit extends carticulos2Dstock {
	...
	// Page object name
	var $PageObjName = 'articulos2Dstock_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("articulos2Dstocklist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($articulos2Dstock_edit)) $articulos2Dstock_edit = new carticulos2Dstock_edit();

// Page init
$articulos2Dstock_edit->Page_Init();

// Page main
$articulos2Dstock_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$articulos2Dstock_edit->Page_Render();
?>
...
var CurrentForm = farticulos2Dstockedit = new ew_Form("farticulos2Dstockedit", "edit");

// Validate form
farticulos2Dstockedit.Validate = function() {
...
farticulos2Dstockedit.Form_CustomValidate = 
...
farticulos2Dstockedit.ValidateRequired = true;
<?php } else { ?>
farticulos2Dstockedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
farticulos2Dstockedit.Lists["x_idArticulo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacionExterna","x_denominacionInterna","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"articulos"};
farticulos2Dstockedit.Lists["x_idUnidadMedida"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"unidades2Dmedida"};
...
<?php if (!$articulos2Dstock_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $articulos2Dstock_edit->ShowPageHeader(); ?>
<?php
$articulos2Dstock_edit->ShowMessage();
?>
<form name="farticulos2Dstockedit" id="farticulos2Dstockedit" class="<?php echo $articulos2Dstock_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($articulos2Dstock_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $articulos2Dstock_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="articulos2Dstock" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($articulos2Dstock->id->CurrentValue) ?>">
<?php if (!$articulos2Dstock_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $articulos2Dstock_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
farticulos2Dstockedit.Init();
</script>
<?php
$articulos2Dstock_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$articulos2Dstock_edit->Page_Terminate();
?>
