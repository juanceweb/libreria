...
class clocalidades extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('localidades', 'localidades', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('localidades', 'localidades', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// idProvincia
		$this->idProvincia = new cField('localidades', 'localidades', 'x_idProvincia', 'idProvincia', '`idProvincia`', '`idProvincia`', 3, -1, FALSE, '`idProvincia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// idPartido
		$this->idPartido = new cField('localidades', 'localidades', 'x_idPartido', 'idPartido', '`idPartido`', '`idPartido`', 3, -1, FALSE, '`idPartido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
