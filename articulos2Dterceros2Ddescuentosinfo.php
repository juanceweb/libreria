...
$articulos2Dterceros2Ddescuentos = NULL;

//
// Table class for articulos-terceros-descuentos
//
class carticulos2Dterceros2Ddescuentos extends cTable {
	var $id;
	var $idArticulo;
	var $idTercero;
	var $descuento;
	...
	function __construct() {
		...
		$this->TableVar = 'articulos2Dterceros2Ddescuentos';
		$this->TableName = 'articulos-terceros-descuentos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`articulos-terceros-descuentos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('articulos2Dterceros2Ddescuentos', 'articulos-terceros-descuentos', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// idArticulo
		$this->idArticulo = new cField('articulos2Dterceros2Ddescuentos', 'articulos-terceros-descuentos', 'x_idArticulo', 'idArticulo', '`idArticulo`', '`idArticulo`', 3, -1, FALSE, '`idArticulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// idTercero
		$this->idTercero = new cField('articulos2Dterceros2Ddescuentos', 'articulos-terceros-descuentos', 'x_idTercero', 'idTercero', '`idTercero`', '`idTercero`', 3, -1, FALSE, '`idTercero`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// descuento
		$this->descuento = new cField('articulos2Dterceros2Ddescuentos', 'articulos-terceros-descuentos', 'x_descuento', 'descuento', '`descuento`', '`descuento`', 4, -1, FALSE, '`descuento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`articulos-terceros-descuentos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "articulos2Dterceros2Ddescuentoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("articulos2Dterceros2Ddescuentosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("articulos2Dterceros2Ddescuentosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "articulos2Dterceros2Ddescuentosadd.php?" . $this->UrlParm($parm);
		else
			$url = "articulos2Dterceros2Ddescuentosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("articulos2Dterceros2Ddescuentosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("articulos2Dterceros2Ddescuentosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("articulos2Dterceros2Ddescuentosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Inserted($rsold, &$rsnew) {
		...
		clonarDescuentos($rsnew["idTercero"], 'all' , 'artículo');	
	...
	function Row_Deleted(&$rs) {
		include_once('./funciones.php');
		clonarDescuentos($rs["idTercero"], 'all' , 'artículo');
