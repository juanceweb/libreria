...
$condiciones2Diva = NULL;

//
// Table class for condiciones-iva
//
class ccondiciones2Diva extends cTable {
	var $id;
	var $denominacion;
	...
	function __construct() {
		...
		$this->TableVar = 'condiciones2Diva';
		$this->TableName = 'condiciones-iva';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`condiciones-iva`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('condiciones2Diva', 'condiciones-iva', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('condiciones2Diva', 'condiciones-iva', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// denominacionCorta
		$this->denominacionCorta = new cField('condiciones2Diva', 'condiciones-iva', 'x_denominacionCorta', 'denominacionCorta', '`denominacionCorta`', '`denominacionCorta`', 200, -1, FALSE, '`denominacionCorta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "comprobantes2Dbloqueados2Dcondiciones2Diva") {
			$sDetailUrl = $GLOBALS["comprobantes2Dbloqueados2Dcondiciones2Diva"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "condiciones2Divalist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`condiciones-iva`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "condiciones2Divalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("condiciones2Divaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("condiciones2Divaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "condiciones2Divaadd.php?" . $this->UrlParm($parm);
		else
			$url = "condiciones2Divaadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("condiciones2Divaedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("condiciones2Divaedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("condiciones2Divaadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("condiciones2Divaadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("condiciones2Divadelete.php", $this->UrlParm());
	}
