...
<?php if ($marcas->denominacion->Visible) { // denominacion ?>
		<th><span id="elh_marcas_denominacion" class="marcas_denominacion"><?php echo $marcas->denominacion->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($marcas->denominacion->Visible) { // denominacion ?>
		<td<?php echo $marcas->denominacion->CellAttributes() ?>>
<span id="el<?php echo $marcas_delete->RowCnt ?>_marcas_denominacion" class="marcas_denominacion">
