...
$unidades2Dmedida_add = NULL; // Initialize page object first

class cunidades2Dmedida_add extends cunidades2Dmedida {
	...
	// Page object name
	var $PageObjName = 'unidades2Dmedida_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "unidades2Dmedidaview.php")
	...
	function LoadDefaultValues() {
		...
		$this->indiceConversion->CurrentValue = 1;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// indiceConversion
		$this->indiceConversion->SetDbValueDef($rsnew, $this->indiceConversion->CurrentValue, 0, strval($this->indiceConversion->CurrentValue) == "");
...
// Create page object
if (!isset($unidades2Dmedida_add)) $unidades2Dmedida_add = new cunidades2Dmedida_add();

// Page init
$unidades2Dmedida_add->Page_Init();

// Page main
$unidades2Dmedida_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$unidades2Dmedida_add->Page_Render();
?>
...
var CurrentForm = funidades2Dmedidaadd = new ew_Form("funidades2Dmedidaadd", "add");

// Validate form
funidades2Dmedidaadd.Validate = function() {
...
funidades2Dmedidaadd.Form_CustomValidate = 
...
funidades2Dmedidaadd.ValidateRequired = true;
<?php } else { ?>
funidades2Dmedidaadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$unidades2Dmedida_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $unidades2Dmedida_add->ShowPageHeader(); ?>
<?php
$unidades2Dmedida_add->ShowMessage();
?>
<form name="funidades2Dmedidaadd" id="funidades2Dmedidaadd" class="<?php echo $unidades2Dmedida_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($unidades2Dmedida_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $unidades2Dmedida_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $unidades2Dmedida_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
funidades2Dmedidaadd.Init();
</script>
<?php
$unidades2Dmedida_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$unidades2Dmedida_add->Page_Terminate();
?>
