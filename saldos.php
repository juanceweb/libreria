...
$saldos_php = NULL; // Initialize page object first
...
class csaldos_php {
	...
	// Table name
	var $TableName = 'saldos.php';

	// Page object name
	var $PageObjName = 'saldos_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'saldos.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "saldos_php", $url, "", "saldos_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($saldos_php)) $saldos_php = new csaldos_php();

// Page init
$saldos_php->Page_Init();

// Page main
$saldos_php->Page_Main();
		      ...
		      success: function (response) {
		      	...
		      	var saldo = 0;
		    		...
		    		for (var i = 0; i< Object.keys(response["exito"]).length ; i++) {
		    			...
		    			var debe = parseFloat(response["exito"][i]["debe"]);
		    			var haber = parseFloat(response["exito"][i]["haber"]);
		    			...
		    			if (response["exito"][i]["tercero"] != ultimotercero) {
		    				...
		    				if (i != 0) {
				    			...
				    			html += '<td style="font-weight: bold;background-color:#888;color:white;border-top-style: double;border-color: black;border-width: medium;"><b>Saldo</b></td>'
		    					html += '<td style="font-weight: bold;background-color:#888;color:white;border-top-style: double;border-color: black;border-width: medium;" >'+saldo.toFixed(2)+'</td>';
		    					...
		    					html += '<td align="right" style="font-weight: bold;background-color:#888;color:white;border-top-style: double;border-color: black;border-width: medium;" >'+importedebe.toFixed(2)+'</td>';
		    					html += '<td align="right" style="font-weight: bold;background-color:#888;color:white;border-top-style: double;border-color: black;border-width: medium;" >'+importehaber.toFixed(2)+'</td>';		    					
		    					html += '</tr>';
		    					html += '<tr>';
		    				...
		    				html += '<tr style="font-weight: bold; background-color:#666; color:white">';
			 	   			...
			 	   			html +='<td style="font-weight: bold; background-color:#666; color:white">Fecha Vencimiento</td>';
			 	   			...
			 	   			html +='<td align="right" style="font-weight: bold; background-color:#666; color:white">Debe</td>';
			 	   			html +='<td align="right" style="font-weight: bold; background-color:#666; color:white">Haber</td>';
			 	   			html += '</tr>';
		    			...
		    			html += '<td>'+response["exito"][i]["fechaVencimiento"]+'</td>';
		    			html += '<td>'+response["exito"][i]["comprobante"]+'</td>';
		    			html += '<td>'+response["exito"][i]["numeroComprobante"]+'</td>';
		    			html += '<td align="right">'+response["exito"][i]["debe"]+'</td>';
		    			html += '<td align="right">'+response["exito"][i]["haber"]+'</td>';
