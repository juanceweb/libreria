...
$movimientos_add = NULL; // Initialize page object first

class cmovimientos_add extends cmovimientos {
	...
	// Page object name
	var $PageObjName = 'movimientos_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "movimientosview.php")
	...
	function LoadDefaultValues() {
		$this->nroComprobanteCompleto->CurrentValue = NULL;
		$this->nroComprobanteCompleto->OldValue = $this->nroComprobanteCompleto->CurrentValue;
		$this->tipoMovimiento->CurrentValue = NULL;
		$this->tipoMovimiento->OldValue = $this->tipoMovimiento->CurrentValue;
		$this->fecha->CurrentValue = NULL;
		$this->fecha->OldValue = $this->fecha->CurrentValue;
		$this->codTercero->CurrentValue = NULL;
		$this->codTercero->OldValue = $this->codTercero->CurrentValue;
		$this->idTercero->CurrentValue = NULL;
		$this->idTercero->OldValue = $this->idTercero->CurrentValue;
		$this->idComprobante->CurrentValue = NULL;
		$this->idComprobante->OldValue = $this->idComprobante->CurrentValue;
		$this->importeTotal->CurrentValue = NULL;
		$this->importeTotal->OldValue = $this->importeTotal->CurrentValue;
		$this->importeIva->CurrentValue = NULL;
		$this->importeIva->OldValue = $this->importeIva->CurrentValue;
		$this->importeNeto->CurrentValue = NULL;
		$this->importeNeto->OldValue = $this->importeNeto->CurrentValue;
		$this->importeCancelado->CurrentValue = NULL;
		$this->importeCancelado->OldValue = $this->importeCancelado->CurrentValue;
		$this->cae->CurrentValue = NULL;
		$this->cae->OldValue = $this->cae->CurrentValue;
		$this->vtoCae->CurrentValue = NULL;
		$this->vtoCae->OldValue = $this->vtoCae->CurrentValue;
		$this->idEstado->CurrentValue = NULL;
		$this->idEstado->OldValue = $this->idEstado->CurrentValue;
		$this->idUsuarioAlta->CurrentValue = NULL;
		$this->idUsuarioAlta->OldValue = $this->idUsuarioAlta->CurrentValue;
		$this->fechaAlta->CurrentValue = NULL;
		$this->fechaAlta->OldValue = $this->fechaAlta->CurrentValue;
		$this->idUsuarioModificacion->CurrentValue = NULL;
		$this->idUsuarioModificacion->OldValue = $this->idUsuarioModificacion->CurrentValue;
		$this->fechaModificacion->CurrentValue = NULL;
		$this->fechaModificacion->OldValue = $this->fechaModificacion->CurrentValue;
		$this->contable->CurrentValue = NULL;
		$this->contable->OldValue = $this->contable->CurrentValue;
		$this->archivo->CurrentValue = NULL;
		$this->archivo->OldValue = $this->archivo->CurrentValue;
		$this->valorDolar->CurrentValue = NULL;
		$this->valorDolar->OldValue = $this->valorDolar->CurrentValue;
		$this->comentarios->CurrentValue = NULL;
		$this->comentarios->OldValue = $this->comentarios->CurrentValue;
		$this->articulosAsociados->CurrentValue = NULL;
		$this->articulosAsociados->OldValue = $this->articulosAsociados->CurrentValue;
		$this->movimientosAsociados->CurrentValue = NULL;
		$this->movimientosAsociados->OldValue = $this->movimientosAsociados->CurrentValue;
		$this->condicionVenta->CurrentValue = 0;
		$this->vigencia->CurrentValue = 0;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// nroComprobanteCompleto
		$this->nroComprobanteCompleto->SetDbValueDef($rsnew, $this->nroComprobanteCompleto->CurrentValue, NULL, FALSE);

		// tipoMovimiento
		$this->tipoMovimiento->SetDbValueDef($rsnew, $this->tipoMovimiento->CurrentValue, NULL, FALSE);

		// fecha
		$this->fecha->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->fecha->CurrentValue, 0), NULL, FALSE);

		// codTercero
		$this->codTercero->SetDbValueDef($rsnew, $this->codTercero->CurrentValue, NULL, FALSE);

		// idTercero
		$this->idTercero->SetDbValueDef($rsnew, $this->idTercero->CurrentValue, NULL, FALSE);

		// idComprobante
		$this->idComprobante->SetDbValueDef($rsnew, $this->idComprobante->CurrentValue, NULL, FALSE);

		// importeTotal
		$this->importeTotal->SetDbValueDef($rsnew, $this->importeTotal->CurrentValue, NULL, FALSE);

		// importeIva
		$this->importeIva->SetDbValueDef($rsnew, $this->importeIva->CurrentValue, NULL, FALSE);

		// importeNeto
		$this->importeNeto->SetDbValueDef($rsnew, $this->importeNeto->CurrentValue, NULL, FALSE);

		// importeCancelado
		$this->importeCancelado->SetDbValueDef($rsnew, $this->importeCancelado->CurrentValue, NULL, FALSE);

		// cae
		$this->cae->SetDbValueDef($rsnew, $this->cae->CurrentValue, NULL, FALSE);

		// vtoCae
		$this->vtoCae->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->vtoCae->CurrentValue, 0), NULL, FALSE);

		// idEstado
		$this->idEstado->SetDbValueDef($rsnew, $this->idEstado->CurrentValue, NULL, FALSE);

		// idUsuarioAlta
		$this->idUsuarioAlta->SetDbValueDef($rsnew, $this->idUsuarioAlta->CurrentValue, NULL, FALSE);

		// fechaAlta
		$this->fechaAlta->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->fechaAlta->CurrentValue, 0), NULL, FALSE);

		// idUsuarioModificacion
		$this->idUsuarioModificacion->SetDbValueDef($rsnew, $this->idUsuarioModificacion->CurrentValue, NULL, FALSE);

		// fechaModificacion
		$this->fechaModificacion->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->fechaModificacion->CurrentValue, 0), NULL, FALSE);

		// contable
		$this->contable->SetDbValueDef($rsnew, $this->contable->CurrentValue, NULL, FALSE);

		// archivo
		$this->archivo->SetDbValueDef($rsnew, $this->archivo->CurrentValue, NULL, FALSE);

		// valorDolar
		$this->valorDolar->SetDbValueDef($rsnew, $this->valorDolar->CurrentValue, NULL, FALSE);

		// comentarios
		$this->comentarios->SetDbValueDef($rsnew, $this->comentarios->CurrentValue, NULL, FALSE);

		// articulosAsociados
		$this->articulosAsociados->SetDbValueDef($rsnew, $this->articulosAsociados->CurrentValue, NULL, FALSE);

		// movimientosAsociados
		$this->movimientosAsociados->SetDbValueDef($rsnew, $this->movimientosAsociados->CurrentValue, NULL, FALSE);

		// condicionVenta
		$this->condicionVenta->SetDbValueDef($rsnew, $this->condicionVenta->CurrentValue, NULL, strval($this->condicionVenta->CurrentValue) == "");

		// vigencia
		$this->vigencia->SetDbValueDef($rsnew, $this->vigencia->CurrentValue, NULL, strval($this->vigencia->CurrentValue) == "");
...
// Create page object
if (!isset($movimientos_add)) $movimientos_add = new cmovimientos_add();

// Page init
$movimientos_add->Page_Init();

// Page main
$movimientos_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$movimientos_add->Page_Render();
?>
...
var CurrentForm = fmovimientosadd = new ew_Form("fmovimientosadd", "add");

// Validate form
fmovimientosadd.Validate = function() {
...
fmovimientosadd.Form_CustomValidate = 
...
fmovimientosadd.ValidateRequired = true;
<?php } else { ?>
fmovimientosadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmovimientosadd.Lists["x_tipoMovimiento"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmovimientosadd.Lists["x_tipoMovimiento"].Options = <?php echo json_encode($movimientos->tipoMovimiento->Options()) ?>;
fmovimientosadd.Lists["x_idTercero"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"terceros"};
fmovimientosadd.Lists["x_idComprobante"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"comprobantes"};
fmovimientosadd.Lists["x_idEstado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmovimientosadd.Lists["x_idEstado"].Options = <?php echo json_encode($movimientos->idEstado->Options()) ?>;
...
<?php if (!$movimientos_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $movimientos_add->ShowPageHeader(); ?>
<?php
$movimientos_add->ShowMessage();
?>
<form name="fmovimientosadd" id="fmovimientosadd" class="<?php echo $movimientos_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($movimientos_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $movimientos_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fmovimientosadd", "x_fecha", 0);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $movimientos_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmovimientosadd.Init();
</script>
<?php
$movimientos_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$movimientos_add->Page_Terminate();
?>
