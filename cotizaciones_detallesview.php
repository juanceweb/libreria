...
$cotizaciones_detalles_view = NULL; // Initialize page object first

class ccotizaciones_detalles_view extends ccotizaciones_detalles {
	...
	// Page object name
	var $PageObjName = 'cotizaciones_detalles_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "cotizaciones_detalleslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cotizaciones_detalleslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cotizaciones_detalleslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($cotizaciones_detalles_view)) $cotizaciones_detalles_view = new ccotizaciones_detalles_view();

// Page init
$cotizaciones_detalles_view->Page_Init();

// Page main
$cotizaciones_detalles_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cotizaciones_detalles_view->Page_Render();
?>
...
var CurrentForm = fcotizaciones_detallesview = new ew_Form("fcotizaciones_detallesview", "view");

// Form_CustomValidate event
fcotizaciones_detallesview.Form_CustomValidate = 
...
fcotizaciones_detallesview.ValidateRequired = true;
<?php } else { ?>
fcotizaciones_detallesview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($cotizaciones_detalles->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$cotizaciones_detalles_view->IsModal) { ?>
<?php if ($cotizaciones_detalles->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $cotizaciones_detalles_view->ExportOptions->Render("body") ?>
<?php
	foreach ($cotizaciones_detalles_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$cotizaciones_detalles_view->IsModal) { ?>
<?php if ($cotizaciones_detalles->Export == "") { ?>
...
<?php } ?>
<?php $cotizaciones_detalles_view->ShowPageHeader(); ?>
<?php
$cotizaciones_detalles_view->ShowMessage();
?>
<form name="fcotizaciones_detallesview" id="fcotizaciones_detallesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cotizaciones_detalles_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cotizaciones_detalles_view->Token ?>">
<?php } ?>
...
<?php if ($cotizaciones_detalles->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_cotizaciones_detalles_id"><?php echo $cotizaciones_detalles->id->FldCaption() ?></span></td>
...
<?php echo $cotizaciones_detalles->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones_detalles->idCotizacion->Visible) { // idCotizacion ?>
	<tr id="r_idCotizacion">
		<td><span id="elh_cotizaciones_detalles_idCotizacion"><?php echo $cotizaciones_detalles->idCotizacion->FldCaption() ?></span></td>
...
<?php echo $cotizaciones_detalles->idCotizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones_detalles->idArticulo->Visible) { // idArticulo ?>
	<tr id="r_idArticulo">
		<td><span id="elh_cotizaciones_detalles_idArticulo"><?php echo $cotizaciones_detalles->idArticulo->FldCaption() ?></span></td>
...
<?php echo $cotizaciones_detalles->idArticulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones_detalles->cantidad->Visible) { // cantidad ?>
	<tr id="r_cantidad">
		<td><span id="elh_cotizaciones_detalles_cantidad"><?php echo $cotizaciones_detalles->cantidad->FldCaption() ?></span></td>
...
<?php echo $cotizaciones_detalles->cantidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones_detalles->referencia->Visible) { // referencia ?>
	<tr id="r_referencia">
		<td><span id="elh_cotizaciones_detalles_referencia"><?php echo $cotizaciones_detalles->referencia->FldCaption() ?></span></td>
...
<?php echo $cotizaciones_detalles->referencia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones_detalles->precioReferencia->Visible) { // precioReferencia ?>
	<tr id="r_precioReferencia">
		<td><span id="elh_cotizaciones_detalles_precioReferencia"><?php echo $cotizaciones_detalles->precioReferencia->FldCaption() ?></span></td>
...
<?php echo $cotizaciones_detalles->precioReferencia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cotizaciones_detalles->idAlicuota->Visible) { // idAlicuota ?>
	<tr id="r_idAlicuota">
		<td><span id="elh_cotizaciones_detalles_idAlicuota"><?php echo $cotizaciones_detalles->idAlicuota->FldCaption() ?></span></td>
...
<?php echo $cotizaciones_detalles->idAlicuota->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($cotizaciones_detalles->Export == "") { ?>
<script type="text/javascript">
fcotizaciones_detallesview.Init();
</script>
<?php } ?>
<?php
$cotizaciones_detalles_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($cotizaciones_detalles->Export == "") { ?>
...
<?php
$cotizaciones_detalles_view->Page_Terminate();
?>
