...
$subcategoria2Dterceros2Ddescuentos_grid = NULL; // Initialize page object first

class csubcategoria2Dterceros2Ddescuentos_grid extends csubcategoria2Dterceros2Ddescuentos {
	...
	// Page object name
	var $PageObjName = 'subcategoria2Dterceros2Ddescuentos_grid';

	// Grid form hidden field names
	var $FormName = 'fsubcategoria2Dterceros2Ddescuentosgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["subcategoria2Dterceros2Ddescuentos"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_idSubcategoria") && $objForm->HasValue("o_idSubcategoria") && $this->idSubcategoria->CurrentValue <> $this->idSubcategoria->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_idTercero") && $objForm->HasValue("o_idTercero") && $this->idTercero->CurrentValue <> $this->idTercero->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_descuento") && $objForm->HasValue("o_descuento") && $this->descuento->CurrentValue <> $this->descuento->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->idSubcategoria->setOldValue($objForm->GetValue("o_idSubcategoria"));
		...
		$this->descuento->setOldValue($objForm->GetValue("o_descuento"));
	...
	function RenderRow() {
		...
		$this->descuento->ViewCustomAttributes = "";
			...
			$this->descuento->EditValue = ew_FormatNumber($this->descuento->EditValue, -2, -1, -2, 0);
			$this->descuento->OldValue = $this->descuento->EditValue;
			}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "subcategorias2Darticulos") {
			...
			if ($GLOBALS["subcategorias2Darticulos"]->EventCancelled) $this->EventCancelled = TRUE;
		}
