...
//
class ccotizaciones extends cTable {
	var $id;
	var $idTercero;
	var $fecha;
	var $contable;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('cotizaciones', 'cotizaciones', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// idTercero
		$this->idTercero = new cField('cotizaciones', 'cotizaciones', 'x_idTercero', 'idTercero', '`idTercero`', '`idTercero`', 19, -1, FALSE, '`idTercero`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// fecha
		$this->fecha = new cField('cotizaciones', 'cotizaciones', 'x_fecha', 'fecha', '`fecha`', 'DATE_FORMAT(`fecha`, \'%Y/%m/%d\')', 135, 0, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// contable
		$this->contable = new cField('cotizaciones', 'cotizaciones', 'x_contable', 'contable', '`contable`', '`contable`', 19, -1, FALSE, '`contable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->contable->Sortable = TRUE; // Allow sort
		$this->contable->OptionCount = 1;
		$this->contable->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['contable'] = &$this->contable;

		// importeNeto
		$this->importeNeto = new cField('cotizaciones', 'cotizaciones', 'x_importeNeto', 'importeNeto', '`importeNeto`', '`importeNeto`', 4, -1, FALSE, '`importeNeto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// importeIva
		$this->importeIva = new cField('cotizaciones', 'cotizaciones', 'x_importeIva', 'importeIva', '`importeIva`', '`importeIva`', 4, -1, FALSE, '`importeIva`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// importeTotal
		$this->importeTotal = new cField('cotizaciones', 'cotizaciones', 'x_importeTotal', 'importeTotal', '`importeTotal`', '`importeTotal`', 4, -1, FALSE, '`importeTotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// estado
		$this->estado = new cField('cotizaciones', 'cotizaciones', 'x_estado', 'estado', '`estado`', '`estado`', 19, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->estado->Sortable = FALSE; // Allow sort
		$this->estado->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['estado'] = &$this->estado;

		// vigencia
		$this->vigencia = new cField('cotizaciones', 'cotizaciones', 'x_vigencia', 'vigencia', '`vigencia`', '`vigencia`', 19, -1, FALSE, '`vigencia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cotizaciones`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cotizacionesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cotizacionesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cotizacionesadd.php?" . $this->UrlParm($parm);
		else
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("cotizacionesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("cotizacionesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cotizacionesdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Deleted(&$rs) {
		...
		//echo "Row Deleted";
			ew_Execute("DELETE FROM `cotizaciones_detalle` WHERE idCotizacion=" . $rs["id"]);
	}
