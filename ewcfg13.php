...
define("EW_PROJECT_NAME", "trama_gestion", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{7FFE1683-B3E8-4940-BA6E-6837E8BA6642}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '58P136BWmelEp0nf', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/trama_gestion.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "librer14_valle", "pass" => "D3spDvhkEDk6P8m", "db" => "librer14_produccion", "qs" => "`", "qe" => "`");
$EW_CONN[0] = &$EW_CONN["DB"];
$EW_CONN["walger1"] = array("conn" => NULL, "id" => "walger1", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "walger", "qs" => "`", "qe" => "`", "new" => TRUE);
$EW_CONN[1] = &$EW_CONN["walger1"];
$EW_CONN["ecommerce"] = array("conn" => NULL, "id" => "ecommerce", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "ecommerce", "qs" => "`", "qe" => "`", "new" => TRUE);
$EW_CONN[2] = &$EW_CONN["ecommerce"];
