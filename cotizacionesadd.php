...
$cotizaciones_add = NULL; // Initialize page object first

class ccotizaciones_add extends ccotizaciones {
	...
	// Page object name
	var $PageObjName = 'cotizaciones_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cotizacionesview.php")
...
// Create page object
if (!isset($cotizaciones_add)) $cotizaciones_add = new ccotizaciones_add();

// Page init
$cotizaciones_add->Page_Init();

// Page main
$cotizaciones_add->Page_Main();
...
var CurrentForm = fcotizacionesadd = new ew_Form("fcotizacionesadd", "add");
...
fcotizacionesadd.Form_CustomValidate = 
...
fcotizacionesadd.ValidateRequired = true;
<?php } else { ?>
fcotizacionesadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcotizacionesadd.Lists["x_idTercero"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"terceros"};
fcotizacionesadd.Lists["x_contable[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcotizacionesadd.Lists["x_contable[]"].Options = <?php echo json_encode($cotizaciones->contable->Options()) ?>;
...
?>
<form name="fcotizacionesadd" id="fcotizacionesadd" class="<?php echo $cotizaciones_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cotizaciones_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cotizaciones_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cotizaciones_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fcotizacionesadd.Init();
</script>
<?php
...
<?php
$cotizaciones_add->Page_Terminate();
?>
