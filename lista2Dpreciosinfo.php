...
//
// Table class for lista-precios
//
class clista2Dprecios extends cTable {
	var $id;
	var $denominacion;
	var $descuento;
	...
	function __construct() {
		...
		$this->TableVar = 'lista2Dprecios';
		$this->TableName = 'lista-precios';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`lista-precios`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('lista2Dprecios', 'lista-precios', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('lista2Dprecios', 'lista-precios', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// descuento
		$this->descuento = new cField('lista2Dprecios', 'lista-precios', 'x_descuento', 'descuento', '`descuento`', '`descuento`', 4, -1, FALSE, '`descuento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`lista-precios`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("lista2Dpreciosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("lista2Dpreciosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "lista2Dpreciosadd.php?" . $this->UrlParm($parm);
		else
			$url = "lista2Dpreciosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("lista2Dpreciosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("lista2Dpreciosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("lista2Dpreciosdelete.php", $this->UrlParm());
	}
