...
class Afip {
	...
	function __construct($options = array())
	{
		...
		$this->CERT	= $this->RES_FOLDER.'valle20200617_1bcc925dcf24d9e5.crt';
		$this->PRIVATEKEY 	= $this->RES_FOLDER.'privada20200617';
	...
	**/
	public function CreateVoucher($data, $return_response = TRUE)
	{
		$req = array(
			'FeCAEReq' => array(
				'FeCabReq' => array(
