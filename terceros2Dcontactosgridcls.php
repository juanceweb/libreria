...
$terceros2Dcontactos_grid = NULL; // Initialize page object first

class cterceros2Dcontactos_grid extends cterceros2Dcontactos {
	...
	// Page object name
	var $PageObjName = 'terceros2Dcontactos_grid';

	// Grid form hidden field names
	var $FormName = 'fterceros2Dcontactosgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["terceros2Dcontactos"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_idPersona") && $objForm->HasValue("o_idPersona") && $this->idPersona->CurrentValue <> $this->idPersona->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_principal") && $objForm->HasValue("o_principal") && $this->principal->CurrentValue <> $this->principal->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->principal->setOldValue($objForm->GetValue("o_principal"));
