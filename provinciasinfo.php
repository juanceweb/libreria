...
class cprovincias extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('provincias', 'provincias', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('provincias', 'provincias', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// idPais
		$this->idPais = new cField('provincias', 'provincias', 'x_idPais', 'idPais', '`idPais`', '`idPais`', 3, -1, FALSE, '`idPais`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
